...
The subsequent sections go over a number of topics in the order of decreasing
importance. \sref{professional-interests} and \ref{section:technical-skills}
present Ivan’s professional interests and technical skills, respectively, which
...
teaching, and learning, respectively. \sref{academic-qualifications} summarizes
Ivan's formal education. \sref{publications} and \ref{section:projects} list
selected scientific publications and open-source projects, respectively. In
\sref{personal-information}, Ivan's personal information is given.
\sref{conclusion} concludes the paper.

\section{Professional Interests} \slab{professional-interests}

Ivan's professional interest lies in decision-making based on collected evidence
