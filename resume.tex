...
it easier for potential employers to quickly obtain a sufficiently comprehensive
...
own unique background and skill set, making it challenging to navigate. Under
these circumstances, it is important to be able to make a reasonably accurate
estimation if the candidate in question would be a good fit for the job at hand.
Ivan Ukhov is one such candidate, and this paper presents his profile in order
to assist in the aforementioned estimation process. In what follows, we shall
refer to Ivan as the candidate.\footfloat{\linkmarker The omega subscript
...
\ref{section:projects} list his selected scientific publications and open-source
projects, respectively. In \sref{personal-information}, a glimpse into the
candidate's personal life is given. Lastly, \sref{conclusion} concludes the
paper.

\section{Professional Interests} \slab{interests}

We begin with the candidate's professional interests. They are centered on
decision-making based on evidence combined with prior domain knowledge,
answering business questions via inferential and predictive modeling,
optimization of business processes by means of learning from data, and
development of data products. The underlying disciplines are data science,
machine learning, software engineering, and statistics.
...
scheduling and serving of predictive models (Google Cloud Platform). \sep
...
In this section, we go over a few noteworthy courses that the candidate has
...
In this section, we list the most notable scientific publications written by the
candidate, which were made during his Ph.D. education until 2017; see
\sref{education}.
...
In this section, some of the candidate's open-source projects are given. Each
...
\link[,]{https://blog.ivanukhov.com/}{blogs about data science} and learns the
piano. He enjoys typography and type design.

\section{Conclusion} \slab{conclusion}

In this work, we have summarized the highlights of Ivan Ukhov's profile that are
of relevance for potential employers.
