...
superscript indicates the presence of links, which are, of course, not
accessible in print form due to the limitations of the medium.}
...
Python and Rust, including their ecosystems; good knowledge of C++, Go, R, and
shell scripting; strong knowledge of SQL; familiarity with JavaScript, HTML, and
CSS; strong knowledge of TensorFlow; strong knowledge of Google Cloud Platform,
