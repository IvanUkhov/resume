...
follows, we shall refer to Ivan as the candidate.\footfloat{\linkmarker An omega
...
the web with respect to the usage of fonts, as part of the Web Almanac by HTTP
Archive (BigQuery).
